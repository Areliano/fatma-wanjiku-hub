  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? "glass-card shadow-soft py-3" : "bg-transparent py-5"
      )}
    >
        ...
        <ul className="hidden lg:flex items-center gap-1">
          {links.map((l) => (
            <li key={l.href}>
              <a
                href={l.href}
                className="px-3 py-2 text-sm font-semibold text-foreground/70 hover:text-primary transition-smooth rounded-lg"
              >
                {l.label}
              </a>
            </li>
      ...
      {open && (
        <div className="lg:hidden glass-card mt-3 mx-4 rounded-2xl p-4 animate-fade-in shadow-elegant">
            ...
            {links.map((l) => (
              <li key={l.href}>
                <a
                  ...
                  className="block px-4 py-3 rounded-lg font-semibold text-foreground/80 hover:bg-muted hover:text-primary transition-smooth"
                >
                  {l.label}
                </a>
              </li>
